...
def make_mcore_model(
    ...
    if bridge is not None and bridge_type == "megatron-bridge":
        ...
        transformer_layer_spec = make_mcore_layer_specs(hf_config, tf_config, use_lora)
