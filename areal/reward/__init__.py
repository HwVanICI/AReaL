...
VALID_REWARD_FN = ["clevr_count_70k", "geometry3k", "wiki"]
...
def get_custom_reward_fn(path: str, **kwargs):
    if "clevr_count_70k" in path:
        ...
        from .wiki import wiki_reward_fn
        return wiki_reward_fn
    
    elif "amc12" in path:
        from .amc12 import amc12_mc_reward_fn
        return amc12_mc_reward_fn
    else:
        raise ValueError(
...
logger = logging.getLogger("MathMultipleChoiceVerifyWorker")

# # Reuse your existing canon helpers if you already have them.
