...
- [MindSpeedEngine Configuration](section-mind-speed-engine)
...
| `mindspeed`                 | [`MindSpeedEngineConfig`](section-mind-speed-engine) | **Required**          | -                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `num_layers_in_first_pipeline_stage`       | integer \| None                                                      | `None`       | Number of layers in the first pipeline stage                                                                                                                                                      |
...
## MindSpeedEngine Configuration

Additional config options for MindSpeed's Megatron adapter

Any Megatron-specific settings will be taken from the MegatronEngineConfig Any
MindSpeed-exclusive features will be supported here Other MindSpeed parameters can be
added below

| Parameter                           | Type    | Default              | Description                                                                                                                                                                             |
| ----------------------------------- | ------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `use_flash_attn`                    | boolean | `True`               | -                                                                                                                                                                                       |
| `context_parallel_algo`             | string  | `"megatron_cp_algo"` | Context parallel algorithm used by MindSpeed. Options: 'megatron_cp_algo', 'hybrid_cp_algo', 'ulysses_cp_algo                                                                           |
| `sequence_parallel`                 | boolean | `False`              | -                                                                                                                                                                                       |
| `use_legacy_models`                 | boolean | `False`              | -                                                                                                                                                                                       |
| `swap_optimizer`                    | boolean | `False`              | -                                                                                                                                                                                       |
| `use_fused_rotary_pos_emb`          | boolean | `False`              | -                                                                                                                                                                                       |
| `use_fused_swiglu`                  | boolean | `False`              | -                                                                                                                                                                                       |
| `use_cp_send_recv_overlap`          | boolean | `False`              | -                                                                                                                                                                                       |
| `use_fused_ring_attention_update`   | boolean | `False`              | -                                                                                                                                                                                       |
| `cp_window_size`                    | integer | `1`                  | -                                                                                                                                                                                       |
| `moe_alltoall_overlap_comm`         | boolean | `False`              | -                                                                                                                                                                                       |
| `moe_grouped_gemm`                  | boolean | `True`               | -                                                                                                                                                                                       |
| `moe_zero_memory`                   | string  | `"disable"`          | MoE zero memory level. Defines how much recomputation occurs in experts when using communications overlaps. Requires moe_alltoall_overlap_comm. Options: 'disable', 'level0', 'level1'. |
| `moe_permute_fusion`                | boolean | `False`              | -                                                                                                                                                                                       |
| `gemm_gradient_accumulation_fusion` | boolean | `False`              | -                                                                                                                                                                                       |
| `position_embedding_type`           | string  | `"rope"`             | Position embedding type. Options: 'rope', 'alibi'                                                                                                                                       |
| `moe_aux_loss_coeff`                | float   | `0.0`                | -                                                                                                                                                                                       |
| `moe_router_load_balancing_type`    | string  | `"aux_loss"`         | -                                                                                                                                                                                       |
| `moe_token_dispatcher_type`         | string  | `"allgather"`        | Type of token dispatcher. Options: 'allgather','alltoall' and 'flex'.                                                                                                                   |
