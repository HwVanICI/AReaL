...
The following values are mean training rollout rewards reported by `rollout/reward` or `rollout/reward/domain` at the indicated training step;
they are not held-out validation scores. Because training reward can vary with sampling,
use these values as reference points rather than exact reproduction targets.

| Run | Reported domain | Mean training reward | Training step |
| --- | --- | ---: | ---: |
| AIME expert | AIME | 0.7004 | 55 |
| LeetCode expert | LeetCode | 0.7327 | 98 |
| MOPD student | AIME | 0.7557 | 24 |
| MOPD student | LeetCode | 0.6964 | 24 |
| MOPD student | Overall | 0.7265 |24 |
